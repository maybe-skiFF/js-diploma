...
function getSavedColumns() {
   if (localStorage.getItem('backlogItems')) {
      ...
      backlogListArray = ['Go home', 'Read book'];
      progressListArray = ['Watch movie', 'Listen to music'];
      completeListArray = ['Read a book', 'Go to the store'];
      onHoldListArray = ['Go on vacation'];
      }
}
